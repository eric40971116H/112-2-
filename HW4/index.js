...
async function MS_TextSentimentAnalysis(thisEvent){
    ...
    if (results[0].sentiment == 'positive'){
      response1 = '正向' + '。信心指數:' + results[0].confidenceScores.positive;
    }
    else if(results[0].sentiment == 'neutral'){
      response1 = '中性' + '。信心指數:' + results[0].confidenceScores.neutral;
    }
    else{
      response1 = '負向' + '。信心指數:' + results[0].confidenceScores.negative;
    }
